...
\033[1;97m     ██╔══██╗   ╚══██╔══╝██╔═══██╗██╔═══██╗██║
   \033[1;35m██████ ██║█████╗██║   ██║   ██║██║   ██║██║
     ...
     \033[1;97m╚═════╝       ╚═╝    ╚═════╝  ╚═════╝ ╚══════╝\033[1;31m
╔═══════════════════════════════════════════════════════╗
 $a \033[1;32mAll Thông Tin MXH: \033[1;97mhaidang-coder.neocities.org\033[1;31m
║───────────────────────────────────────────────────────║
 $a \033[1;36m\033[1;32mKEY FREE\033[1;36m \033[1;37m
 $a \033[1;36m\033[1;33mBản Quyền: Lê Trọng Hải Đăng\033[1;37m  \033[1;32m  \033[1;31m\033[1;32m
 $a \033[1;35mZalo Admin: 032.5676.804
 $a \033[1;36m\033[1;31mFacebook Admin: letronghaidang.limited\033[1;36m
 $a \033[1;36mIp Tool Của Bạn Là: $ip\033[1;31m
╚═══════════════════════════════════════════════════════╝\033[1;32m\n";
 echo $banner1;
    ...
    if($h >= 0 and $h < 9){
        ...
        $chuc = "Buổi Tối Vui Vẻ!!";
    } else {
        $chuc = "Muộn Rồi Hongg Ngủ À-_-";
    }
    
    $today = date("Y-m-d");
    $key = "HaiDang_";
    
    $long_url = "https://hdangdvmxh.000webhostapp.com/api/index.html?key={$key}";
    $api_token = '5b233a2a4d592b536e6340391823aa72ed66aac4';
    $api_url = "https://link1s.com/api?api={$api_token}&url={$long_url}&alias=";
    $result = @json_decode(file_get_contents($api_url),TRUE);
    if($result["status"] === 'error') {
    echo (" $a Link Key: ".$result["message"]);
    } else {
    echo (" $a Link Key: ".$result["shortenedUrl"]);
    }
    
$a = " \033[1;97m[\033[1;31m+_+\033[1;97m] ➩";
#echo "\n$a \033[1;31mLưu Ý: Nếu Ip Bị Đổi Thì Key Cũng Bị Thay Đổi \033[1;33m\n";
echo "\n$a \033[1;92mVui Lòng Nhập Api Key: \033[1;33m";
...
$thanh = "\033[1;97m [\033[1;31m+_+\033[1;97m] ➩ ";
...
╔═══════════════════════════════════════════════════════╗
 $a \033[1;32mAll Thông Tin MXH: \033[1;97mhaidang-coder.neocities.org\033[1;31m
║───────────────────────────────────────────────────────║
 $a \033[1;36m\033[1;32mTOOL SPAM CALL + OTP\033[1;36m \033[1;37m
 $a \033[1;36m\033[1;33mBản Quyền: Lê Trọng Hải Đăng\033[1;37m  \033[1;32m  \033[1;31m\033[1;32m
 $a \033[1;35mZalo Admin: 032.5676.804
 $a \033[1;36m\033[1;31mFacebook Admin: letronghaidang.limited\033[1;36m
 $a \033[1;36mIp Tool Của Bạn Là: $ip\033[1;31m
...
@system("clear");
echo $banner;
echo $thanh_dep.$luc."Nhập SĐT: $vang";
$sdt = trim(fgets(STDIN));
echo $thanh_dep.$luc."Nhập thời gian nghỉ: $trang";
$delay = trim(fgets(STDIN));
sleep(2);
echo"\033[1;31m────────────────────────────────────────────────────────────\n";
$kho = array("0325676804", "0325676804", "0352803083", "0352803083", "0325676804", );
if ($sdt == "0325676804"){
	echo $thanh.$do."ĐÂY LÀ SĐT ADMIN SPAM CON CẶC =))\n"; usleep(2000000);
	continue;
} elseif(!preg_match('/([0-9])/', $sdt, $math)) {
echo $thanh.$do."Vui Lòng Nhập Đúng Định Dạng SDT\n"; usleep(2000000);
} elseif(in_array($sdt, $kho)) {
echo $thanh.$do."Đổi số đi số này mua bảo kê rồi\n"; usleep(2000000);
...
if($array["MOMO"] == "Thành Công"){
			$dem = $dem + 1;
			echo $do."[".$trang.$dem.$do."] \033[1;37m[".$cyan."LTHĐ~Đz".$trang."] [".$vang."THÀNH CÔNG".$trang."] [".$luc."MOMO".$trang."]\n"; usleep(10000);
		}
		if($array["MOCA"] == "Thành Công"){
			$dem = $dem + 1;
			echo $do."[".$trang.$dem.$do."] \033[1;37m[".$cyan."LTHĐ~Đz".$trang."] [".$vang."THÀNH CÔNG".$trang."] [".$luc."MOCA".$trang."]\n"; usleep(10000);
		}
		if($array["META_VN"] == "Thành Công"){
			$dem = $dem + 1;
			echo $do."[".$trang.$dem.$do."] \033[1;37m[".$cyan."LTHĐ~Đz".$trang."] [".$vang."THÀNH CÔNG".$trang."] [".$luc."META".$trang."]\n"; usleep(10000);
		}
		if($array["FPTSHOP"] == "Thành Công"){
			$dem = $dem + 1;
			echo $do."[".$trang.$dem.$do."] \033[1;37m[".$cyan."LTHĐ~Đz".$trang."] [".$vang."THÀNH CÔNG".$trang."] [".$luc."FPTSHOP".$trang."]\n"; usleep(10000);
		}
		if($array["TV360"] == "Thành Công"){
			$dem = $dem + 1;
			echo $do."[".$trang.$dem.$do."] \033[1;37m[".$cyan."LTHĐ~Đz".$trang."] [".$vang."THÀNH CÔNG".$trang."] [".$luc."TV360".$trang."]\n"; usleep(10000);
		}
		if($array["VIETTELL"] == "Thành Công"){
			$dem = $dem + 1;
			echo $do."[".$trang.$dem.$do."] \033[1;37m[".$cyan."LTHĐ~Đz".$trang."] [".$vang."THÀNH CÔNG".$trang."] [".$luc."VIETTELL".$trang."]\n"; usleep(10000);
		}
		if($array["VIETTELLPAY"] == "Thành công"){
			$dem = $dem + 1;
			echo $do."[".$trang.$dem.$do."] \033[1;37m[".$cyan."LTHĐ~Đz".$trang."] [".$vang."THÀNH CÔNG".$trang."] [".$luc."VIETTELLPAY".$trang."]\n"; usleep(10000);
		}
		if($array["TAMO"] == "Thành Công"){
			$dem = $dem + 1;
			echo $do."[".$trang.$dem.$do."] \033[1;37m[".$cyan."LTHĐ~Đz".$trang."] [".$vang."THÀNH CÔNG".$trang."] [".$luc."TAMO".$trang."]\n"; usleep(10000);
		}
		if($array["VAYNO"] == "Thành công"){
			$dem = $dem + 1;
			echo $do."[".$trang.$dem.$do."] \033[1;37m[".$cyan."LTHĐ~Đz".$trang."] [".$vang."THÀNH CÔNG".$trang."] [".$luc."VAYNO".$trang."]\n"; usleep(10000);
		}
		if($array["ZALOPAY"] == "Thành Công"){
			$dem = $dem + 1;
			echo $do."[".$trang.$dem.$do."] \033[1;37m[".$cyan."LTHĐ~Đz".$trang."] [".$vang."THÀNH CÔNG".$trang."] [".$luc."ZALOPAY".$trang."]\n"; usleep(10000);
		}
		if($array["TIENOI"] == "Thành Công"){
			$dem = $dem + 1;
			echo $do."[".$trang.$dem.$do."] \033[1;37m[".$cyan."LTHĐ~Đz".$trang."] [".$vang."THÀNH CÔNG".$trang."] [".$luc."TIENOI".$trang."]\n"; usleep(10000);
		}
		if($array["LOZI"] == "Thành công"){
			$dem = $dem + 1;
			echo $do."[".$trang.$dem.$do."] \033[1;37m[".$cyan."LTHĐ~Đz".$trang."] [".$vang."THÀNH CÔNG".$trang."] [".$luc."LOZI".$trang."]\n"; usleep(10000);
		}
		if($array["DONGPLUS"] == "Thành Công"){
			$dem = $dem + 1;
			echo $do."[".$trang.$dem.$do."] \033[1;37m[".$cyan."LTHĐ~Đz".$trang."] [".$vang."THÀNH CÔNG".$trang."] [".$luc."DONGPLUS".$trang."]\n"; usleep(10000);
		}
		if($array["POPS"] == "Thành Công"){
			$dem = $dem + 1;
			echo $do."[".$trang.$dem.$do."] \033[1;37m[".$cyan."LTHĐ~Đz".$trang."] [".$vang."THÀNH CÔNG".$trang."] [".$luc."POPS".$trang."]\n"; usleep(10000);
		}
		if($array["VIEON"] == "Thành Công"){
			$dem = $dem + 1;
			echo $do."[".$trang.$dem.$do."] \033[1;37m[".$cyan."LTHĐ~Đz".$trang."] [".$vang."THÀNH CÔNG".$trang."] [".$luc."VIEON".$trang."]\n"; usleep(10000);
			///
		}
		delay($delay);
	unlink("get.txt");
...
function delay($delay)
{
	for ($tt = $delay; $tt >= 1; $tt--) {
		echo "\r\033[1;33m   HĐ~TOOL  \033[1;31m ~>       \033[1;32m LO      \033[1;31m | $tt | ";
		usleep((1/7)*1000000);
		echo "\r\033[1;31m   HĐ~TOOL  \033[1;33m   ~>     \033[1;37m LOA     \033[1;31m | $tt | ";
		usleep((1/7)*1000000);
		echo "\r\033[1;32m   HĐ~TOOL  \033[1;33m     ~>   \033[1;37m LOAD    \033[1;31m | $tt | ";
		usleep((1/7)*1000000);
		echo "\r\033[1;34m   HĐ~TOOL  \033[1;33m      ~>  \033[1;37m LOADI   \033[1;31m | $tt | ";
		usleep((1/7)*1000000);
		echo "\r\033[1;35m   HĐ~TOOL  \033[1;33m       ~> \033[1;37m LOADIN  \033[1;31m | $tt | ";
		usleep((1/7)*1000000);
		echo "\r\033[1;35m   HĐ~TOOL  \033[1;33m       ~> \033[1;37m LOADING \033[1;31m | $tt | ";
		usleep((1/7)*1000000);
		echo "\r\033[1;35m   HĐ~TOOL  \033[1;33m        ~>\033[1;37m LOADING.\033[1;31m | $tt | ";
		usleep((1/7)*1000000);
	}
	echo "\r\033[1;35m    ⚡LÊ TRỌNG HẢI ĐĂNG⚡                   \r";
}
